...
│  ignite.js                                                   │
│    │                                                         │
│    │  buildHtml(statics, dynamics)                            │
│    ▼                                                         │
│  applyUpdate()                                               │
│    │                                                         │
│    ├── morphdom available? ──yes──▶ morphdom(oldDOM, newHTML) │
│    │                                  │                      │
│    │                                  ▼                      │
...
```
  Old DOM (in browser)          New HTML (from server)
  ┌──────────────────┐          ┌──────────────────┐
  │ <div>            │          │ <div>            │
  │   ┌────────────┐ │          │   ┌────────────┐ │
  │   │ <h1>Title  │ │ ── = ──▶│   │ <h1>Title  │ │  skip
  │   └────────────┘ │          │   └────────────┘ │
  │   ┌────────────┐ │          │   ┌────────────┐ │
  │   │ <p>5</p>   │ │ ── ! ──▶│   │ <p>6</p>   │ │  patch text
  │   └────────────┘ │          │   └────────────┘ │
  │   ┌────────────┐ │          │   ┌────────────┐ │
  │   │ <input     │ │ ── = ──▶│   │ <input     │ │  skip (focus
  │   │  value=""> │ │          │   │  value=""> │ │  preserved!)
  │   └────────────┘ │          │   └────────────┘ │
  │ </div>           │          │ </div>           │
  └──────────────────┘          └──────────────────┘
       =  same (skip)     !  different (patch)
```
