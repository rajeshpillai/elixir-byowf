...
│                                                        │
│  2. Server crash / network drop                        │
│     ════════════════╳                                  │
│     Status: "Disconnected" (red)                       │
│                                                        │
│  3. Exponential backoff                                │
│     ──wait 200ms──▶  attempt 1 ╳                       │
│     ──wait 400ms──▶  attempt 2 ╳                       │
│     ──wait 800ms──▶  attempt 3 ✓                       │
│     Status: "Connected" (green)                        │
│     delay resets to 200ms                              │
│                                                        │
│  4. Live navigation                                    │
│     navigating = true  (suppress reconnect)            │
...
```
  ...
  │  └───────────────┘  │         │  └───────────────┘  │
  │                     │         │                     │
  │  ┌── #ignite-app ┐  │         │  ┌── #ignite-app ┐  │
  │  │ click fires!  │  │         │  │ click fires!  │  │
  │  └───────────────┘  │         │  └───────────────┘  │
  │                     │         │                     │
  │  ┌── footer ─────┐  │         │  ┌── footer ─────┐  │
  │  │ click fires!  │  │         │  │ (ignored)     │  │
