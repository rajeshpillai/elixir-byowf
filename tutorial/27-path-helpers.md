...
**Update `lib/ignite/router.ex`** — register the accumulating attribute in the `__using__/1` macro:

```elixir
# In __using__/1 (inside the quote block, alongside @plugs registration)
