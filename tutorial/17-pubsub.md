...
│  Topics:                                                    │
│  ┌─────────────────────┐  ┌──────────────────────────────┐  │
│  │ "shared_counter"    │  │ "chat:lobby"                 │  │
│  │  ├─ PID<0.201.0>   │  │  ├─ PID<0.301.0>            │  │
│  │  ├─ PID<0.205.0>   │  │  └─ PID<0.302.0>            │  │
│  │  └─ PID<0.210.0>   │  │                              │  │
│  └─────────────────────┘  └──────────────────────────────┘  │
│                                                             │
│  broadcast("shared_counter", msg)                           │
│    ──▶ send to all PIDs except sender                       │
└─────────────────────────────────────────────────────────────┘
```
...
│                                  │
│  ┌──────────────┐                │
│  │ Ignite.PubSub│  ◄── starts first (children order matters)
│  │   (:pg)      │                │
│  └──────────────┘                │
│         │                        │
│  ┌──────┴──────────────────────┐ │
